...
# F statistic value
f_ant <- summary(ant_model)$fstatistic[[1]]
f_mom <- summary(mom_model)$fstatistic[[1]]
f_rem <- summary(rem_model)$fstatistic[[1]]
f_dep <- summary(dep_model)$fstatistic[[1]]
...
paths_dep <- tibble(" " = c("$c'_{PA}$", "$b_{1}$", "$b_{2}$", "$b_{3}$", "$c'_{NA}$", "$b_{1}$", "$b_{2}$", "$b_{3}$", rep(" ", 3), "$i_{Y}$"))
paths_ind <- tibble(" " = c(" ", "$a_{1}b_{1}$", "$a_{2}b_{2}$", "$a_{3}b_{3}$", " ", "$a_{i}b_{1}$", "$a_{ii}b_{2}$", "$a_{iii}b_{3}$", rep(" ", 4)))
