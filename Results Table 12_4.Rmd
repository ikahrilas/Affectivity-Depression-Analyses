...
kable(results_total, "latex", escape = FALSE, booktabs = TRUE, align = c("l", rep(c("c", "r", "c", "r"), 4), "c", "r", "c"), linesep = "", caption = "Unstandardized path coefficients from structural equation model using positive and negative affectivity to predict depression with savoring subscales as mediators ($N$ = 1,680)") %>%
  ...
  footnote(general = "$SE$ = Standard Error, PA = Positive Affectivity, NA = Negative Affectivity, ANT = Anticipating, MOM = Savoring the Moment, REM = Reminiscing, DEP = Depression, WOR = Worry, ANX = Anxious Arousal.", threeparttable = TRUE, escape = FALSE) %>%
  row_spec(0, align = "c") %>% 
