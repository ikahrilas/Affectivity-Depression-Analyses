...
```
This is good news - it appears that no more than %3.75 of any variable is missing, so we had a pretty good response rate. Since we have such a large N, we can just omit all cases that have missing values.
